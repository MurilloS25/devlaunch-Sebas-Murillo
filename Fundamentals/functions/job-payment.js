/*
En una empresa un hay proceso donde cada trabajador debe registrar las horas de entrada
...
const main = () => {
  const hourlyRate = parseFloat(promt("HOURLY RATE: "));
  const startTime = promt("START AT: ");
  const endTime = promt("END AT: ");
